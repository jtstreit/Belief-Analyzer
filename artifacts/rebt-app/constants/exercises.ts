...
const rebtShameAttacking: Exercise = {
  ...
  estimatedMinutes: 20,
  caution: 'Choose tasks that are harmless to others and legal. Avoid tasks that could be genuinely offensive or dangerous.',
  icon: 'shield',
  steps: [
    {
      id: 'intro',
...
const rebtRationalImagery: Exercise = {
  ...
  steps: [
    ...
    },
    {
      ...
      instruction: 'What unhealthy emotion do you feel when you vividly imagine this situation? (e.g., depression, panic, rage, self-loathing)',
      type: 'multiline',
...
const exposureSession: Exercise = {
  ...
  rationale: 'Repeated, prolonged exposure (staying in the situation until anxiety reduces by at least 50%) teaches your nervous system that the feared outcome either does not happen or is manageable.',
  estimatedMinutes: 30,
  caution: 'Stay in the situation until your SUDS drops meaningfully. Leaving early (escape) can strengthen anxiety. Remove safety behaviours during the session.',
  icon: 'clock',
  steps: [
    {
      id: 'exposureStep',
